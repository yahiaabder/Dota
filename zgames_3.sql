...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 05 sep. 2023 à 11:09
...
--
-- Base de données :  `zgames_3`
--

-- --------------------------------------------------------

--
-- Structure de la table `access_group_master`
--

DROP TABLE IF EXISTS `access_group_master`;
CREATE TABLE IF NOT EXISTS `access_group_master` (
...
--
-- Déchargement des données de la table `access_group_master`
--

INSERT INTO `access_group_master` (`id`, `admin_id`, `group_id`, `precedence`, `created_at`, `updated_at`) VALUES
(530, '2106122357055', 'Admin', NULL, '2021-06-13 08:12:10', '2021-06-14 02:17:03'),
(531, '2106130541518', 'SuperAdmin', NULL, '2021-06-13 10:42:16', '2021-06-13 10:42:16'),
(533, '2203141115517', 'order-manager-1647236509', NULL, '2022-11-04 13:08:30', '2023-05-17 09:17:13'),
(534, '2305231853322', 'articles-editor-1684848291', 0, '2023-05-23 13:26:28', '2023-05-23 13:26:28'),
(535, '2305241911017', 'seo-blogs-1684935731', 1, '2023-05-24 13:47:53', '2023-05-24 13:47:53'),
(536, '2307201345176', 'banner-manager-1689840973', 3, '2023-07-20 08:25:04', '2023-07-20 08:25:04');

-- --------------------------------------------------------

--
-- Structure de la table `access_modules`
--

DROP TABLE IF EXISTS `access_modules`;
CREATE TABLE IF NOT EXISTS `access_modules` (
  `access_modules_id` varchar(222) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`access_modules_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Déchargement des données de la table `access_modules`
--

INSERT INTO `access_modules` (`access_modules_id`, `section_name`, `segment_1`, `segment_2`, `segment_3`, `created_at`, `updated_at`) VALUES
('AccessManager', 'Access Manager', 'AccessManager', NULL, NULL, '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('AccessModules', 'Access Modules', 'AccessModules', 'index', 'add', '2021-06-14 01:26:01', '2021-06-14 01:26:01'),
('AddAccessManager', 'Add Access Manager', 'AccessManager', 'index', 'add', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('AddAccessModules', 'Add Access Modules', 'AccessModules', NULL, NULL, '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('AddAddBlogCategory', 'Add blog category', 'blog', 'categories', 'add', '2022-11-11 13:28:38', '2022-11-11 13:28:38'),
('AddAddCharges', 'Add Charges', 'Charges', 'index', 'add', '2021-07-25 00:48:24', '2021-07-25 00:48:24'),
('AddAddCoupon', 'Add Coupon', 'Coupon', 'index', 'add', '2021-07-29 12:19:55', '2021-07-29 12:19:55'),
('AddAddFAQ', 'Add FAQ', 'Faq', 'index', 'add', '2021-07-20 04:55:11', '2021-07-20 04:55:11'),
('AddAddGiftWrapping', 'Add Gift Wrapping', 'GiftWrapping', 'index', 'add', '2021-06-21 03:49:11', '2021-06-21 03:49:11'),
('AddAddNewsletterSection', 'Add newsletter section', 'newsletter', 'sections', 'add', '2022-05-25 09:59:02', '2022-05-25 09:59:02'),
('AddAddPackage', 'Add Package', 'Package', 'index', 'add', '2021-09-08 11:56:15', '2021-09-08 11:56:15'),
('AddAddProductReview', 'Add Product Review', 'ProductReview', 'index', 'add', '2021-06-22 10:36:48', '2021-06-22 10:36:48'),
('AddAddStore', 'Add store', 'Zgstores', 'stores', 'add', '2022-11-29 08:54:47', '2022-11-29 08:54:47'),
('AddAddStoreAgent', 'Add store agents', 'stores', 'store_agents', 'add', '2022-11-29 08:54:16', '2022-11-29 08:54:16'),
('AddAddTrending', 'Add Trending', 'Trending', 'index', 'add', '2021-09-08 11:52:32', '2021-09-08 11:52:32'),
('addAdminGroup', 'add AdminGroup', 'AdminGroup', 'index', 'add', '2021-06-13 08:17:21', '2021-06-13 08:17:21'),
('AddAge', 'Age', 'Age', 'index', 'add', '2021-06-16 03:12:58', '2021-06-16 03:12:58'),
('AddBanner', 'Add Banner', 'Banner', 'index', 'add', '2020-12-25 15:28:39', '2020-12-25 15:28:39'),
('AddBlog', 'Blog', 'Blog', 'index', 'add', '2021-07-20 02:50:10', '2021-07-20 02:50:10'),
('AddBrands', 'Brands', 'Brands', 'index', 'add', '2021-06-14 11:38:36', '2021-06-14 11:38:36'),
('AddCategory', 'Category', 'Category', 'index', 'add', '2021-06-14 11:43:24', '2021-06-14 11:43:24'),
('AddCategoryBanner', 'CategoryBanner', 'CategoryBanner', 'index', 'add', '2021-11-11 15:34:30', '2021-11-11 15:34:30'),
('AddCity', 'City', 'City', 'index', 'add', '2021-06-21 04:07:38', '2021-06-21 04:07:38'),
('AddCMS', 'Add CMS', 'CMS', 'index', 'add', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('AddColor', 'Genre', 'Genre', 'index', 'add', '2021-07-31 01:10:16', '2021-07-31 01:10:16'),
('AddCustomer', 'Customer', 'Customer', 'index', 'add', '2021-06-22 10:20:33', '2021-06-22 10:20:33'),
('AddListings', 'Listings', 'Listings', 'freebie', 'add', '2022-01-02 13:08:04', '2022-01-02 13:08:04'),
('addMENU', 'add MENU', 'MENU', 'index', 'add', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('AddNewsletter', 'Add Newsletter', 'Newsletter', 'index', 'add', '2021-09-14 12:10:56', '2021-09-14 12:10:56'),
('AddOfferBanner', 'OfferBanner', 'OfferBanner', 'index', 'add', '2021-07-05 02:14:09', '2021-07-05 02:14:09'),
('AddOrdersProducts', 'Orders products', 'Orders', 'products', 'add', '2021-08-15 09:10:38', '2021-08-15 09:10:38'),
('AddSuitableFor', 'SuitableFor', 'SuitableFor', 'index', 'add', '2021-06-16 03:15:39', '2021-06-16 03:15:39'),
('AddType', 'Add Type', 'Type', 'index', 'add', '2021-08-10 06:00:19', '2021-08-10 06:00:19'),
('AdminGroup', 'Admin Group', 'index', NULL, NULL, '2021-06-13 08:18:48', '2021-06-13 08:18:48'),
('Age', 'Age', 'Age', NULL, NULL, '2021-06-16 03:12:49', '2021-06-16 03:12:49'),
('Blog', 'Blog', 'Blog', 'index', NULL, '2021-07-20 02:49:59', '2021-07-20 02:49:59'),
('BlogCategories', 'Blog categories', 'blog', 'categories', NULL, '2022-11-11 13:28:25', '2022-11-11 13:28:25'),
('Brands', 'Brands', 'Brands', NULL, NULL, '2021-06-14 11:38:30', '2021-06-14 11:38:30'),
('Category', 'Category', 'Category', NULL, NULL, '2021-06-14 11:43:14', '2021-06-14 11:43:14'),
('CategoryBanner', 'CategoryBanner', 'CategoryBanner', NULL, NULL, '2021-11-11 15:34:49', '2021-11-11 15:34:49'),
('Charges', 'Charges', 'Charges', 'index', NULL, '2021-07-25 00:48:12', '2021-07-25 00:48:12'),
('City', 'City', 'City', 'index', NULL, '2021-06-21 04:07:17', '2021-06-21 04:07:17'),
('Color', 'Genre', 'Genre', NULL, NULL, '2021-07-31 01:10:30', '2021-07-31 01:10:30'),
('ContactRequests', 'Contact requests', 'customer', 'contact_requests', NULL, '2022-08-02 10:26:22', '2022-08-02 10:26:22'),
('Coupon', 'Coupon', 'Coupon', 'index', NULL, '2021-07-29 12:19:45', '2021-07-29 12:19:45'),
('Customer', 'Customer', 'Customer', 'index', NULL, '2021-06-22 10:20:27', '2021-06-22 10:20:27'),
('DateWiseOrder', 'dateWiseOrder', 'orders', 'dateWise', NULL, '2022-02-24 04:53:01', '2022-02-24 04:53:01'),
('DateWiseOrderlist', 'dateWiseOrderlist', 'orders', 'dayWise', NULL, '2022-02-24 04:54:36', '2022-02-24 04:54:36'),
('deleteAdminGroup', 'delete Admin Group', 'AdminGroup', 'index', 'delete', '2021-06-13 08:17:54', '2021-06-13 08:17:54'),
('DeleteAge', 'Age', 'Age', 'index', 'delete', '2021-06-16 03:13:20', '2021-06-16 03:13:20'),
('deleteBanner', 'Delete Banner', 'Banner', 'index', 'delete', '2020-12-25 15:28:39', '2020-12-25 15:28:39'),
('DeleteBlog', 'Blog', 'Blog', 'index', 'delete', '2021-07-20 02:50:24', '2021-07-20 02:50:24'),
('DeleteBrands', 'Brands', 'Brands', 'index', 'delete', '2021-06-14 11:38:48', '2021-06-14 11:38:48'),
('DeleteCategory', 'Category', 'Category', 'index', 'delete', '2021-06-14 11:38:07', '2021-06-14 11:38:07'),
('DeleteCategoryBanner', 'CategoryBanner', 'CategoryBanner', 'index', 'delete', '2021-11-11 15:34:45', '2021-11-11 15:34:45'),
('DeleteCity', 'City', 'City', 'index', 'delete', '2021-06-21 04:07:32', '2021-06-21 04:07:32'),
('deleteCMS', 'delete CMS', 'CMS', 'index', 'delete', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('DeleteColor', 'Genre', 'Genre', 'index', 'delete', '2021-07-31 01:10:22', '2021-07-31 01:10:22'),
('DeleteCustomer', 'Customer', 'Customer', 'index', 'delete', '2021-06-22 10:20:46', '2021-06-22 10:20:46'),
('DeleteDeleteBlogCategories', 'Delete blog categories', 'blog', 'categories', 'delete', '2022-11-11 13:29:06', '2022-11-11 13:29:06'),
('DeleteDeleteCharges', 'Delete Charges', 'Charges', 'index', 'delete', '2021-07-25 00:48:46', '2021-07-25 00:48:46'),
('DeleteDeleteCoupon', 'Delete Coupon', 'Coupon', 'index', 'delete', '2021-07-29 12:20:15', '2021-07-29 12:20:15'),
('DeleteDeleteFAQ', 'Delete FAQ ', 'Faq', 'index', 'delete', '2021-07-20 04:55:42', '2021-07-20 04:55:42'),
('DeleteDeleteGiftWrapping', 'Delete GiftWrapping', 'GiftWrapping', 'index', 'delete', '2021-06-21 03:49:33', '2021-06-21 03:49:33'),
('DeleteDeleteNewsletter', 'Delete Newsletter', 'Newsletter', 'index', 'delete', '2021-09-14 12:10:38', '2021-09-14 12:10:38'),
('DeleteDeleteNewsletterSections', 'Delete newsletter sections', 'newsletter', 'sections', 'delete', '2022-05-25 09:59:25', '2022-05-25 09:59:25'),
('DeleteDeletePackage', 'Delete Package', 'Package', 'index', 'delete', '2021-09-08 11:56:56', '2021-09-08 11:56:56'),
('DeleteDeleteProductReview', 'Delete Product Review', 'ProductReview', 'index', 'delete', '2021-06-22 10:37:12', '2021-06-22 10:37:12'),
('DeleteDeleteStoreAgents', 'Delete store agents', 'stores', 'store_agents', 'delete', '2022-11-29 08:52:38', '2022-11-29 08:52:38'),
('DeleteDeleteStores', 'Delete stores', 'Zgstores', 'stores', 'delete', '2022-11-29 08:55:05', '2022-11-29 08:55:05'),
('DeleteDeleteTrending', 'Delete Trending', 'Trending', 'index', 'delete', '2021-09-08 11:53:19', '2021-09-08 11:53:19'),
('DeleteDeleteType', 'delete Type', 'Type', 'index', 'delete', '2021-08-10 05:59:57', '2021-08-10 05:59:57'),
('deleteMENU', 'delete MENU', 'MENU', 'index', 'delete', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('DeleteOfferBanner', 'OfferBanner', 'OfferBanner', 'index', 'delete', '2021-07-05 02:14:21', '2021-07-05 02:14:21'),
('DeleteProducts', 'Products', 'Products', 'index', 'delete', '2021-06-14 11:37:25', '2021-06-14 11:37:25'),
('DeleteSuitableFor', 'SuitableFor', 'SuitableFor', 'index', 'delete', '2021-06-16 03:16:06', '2021-06-16 03:16:06'),
('editAccessManager', 'edit Access Manager', 'AccessManager', 'index', 'edit', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('editAccessModules', 'Edit Access Modules', 'AccessModules', 'index', 'edit', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('editAdminGroup', 'edit Admin Group', 'AdminGroup', 'index', 'edit', '2021-06-13 08:17:38', '2021-06-13 08:17:38'),
('EditAge', 'Age', 'Age', 'index', 'edit', '2021-06-16 03:13:06', '2021-06-16 03:13:06'),
('editBanner', 'Edit Banner', 'Banner', 'index', 'edit', '2020-12-25 15:28:39', '2020-12-25 15:28:39'),
('EditBlog', 'Blog', 'Blog', 'index', 'edit', '2021-07-20 02:50:16', '2021-07-20 02:50:16'),
('EditBrands', 'Brands', 'Brands', 'index', 'edit', '2021-06-14 11:38:42', '2021-06-14 11:38:42'),
('EditCategoryBanner', 'CategoryBanner', 'CategoryBanner', 'index', 'edit', '2021-11-11 15:34:37', '2021-11-11 15:34:37'),
('EditCity', 'City', 'City', 'index', 'edit', '2021-06-21 04:07:22', '2021-06-21 04:07:22'),
('editCMS', 'edit CMS', 'CMS', 'index', 'edit', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('EditColor', 'Genre', 'Genre', 'index', 'edit', '2021-07-31 01:10:38', '2021-07-31 01:10:38'),
('EditCustomer', 'Customer', 'Customer', 'index', 'edit', '2021-06-22 10:20:40', '2021-06-22 10:20:40'),
('EditEditBlogCategory', 'Edit blog category', 'blog', 'categories', 'edit', '2022-11-11 13:28:55', '2022-11-11 13:28:55'),
('EditEditCharges', 'Edit Charges', 'Charges', 'index', 'edit', '2021-07-25 00:48:35', '2021-07-25 00:48:35'),
('EditEditCoupon', 'Edit Coupon', 'Coupon', 'Coupon', 'edit', '2021-07-29 12:20:04', '2021-07-29 12:20:04'),
('EditEditFAQ', 'Edit FAQ', 'Faq', 'index', 'edit', '2021-07-20 04:55:24', '2021-07-20 04:55:24'),
('EditEditGiftWrapping', 'Edit GiftWrapping', 'GiftWrapping', 'index', 'edit', '2021-06-21 03:49:21', '2021-06-21 03:49:21'),
('EditEditNewsletter', 'Edit Newsletter', 'Newsletter', 'index', 'edit', '2021-09-14 12:10:20', '2021-09-14 12:10:20'),
('EditEditNewsletterSections', 'Edit newsletter sections', 'newsletter', 'sections', 'edit', '2022-05-25 09:59:44', '2022-05-25 09:59:44'),
('EditEditOrders', 'Edit Orders', 'Orders', 'index', 'edit', '2021-07-30 04:45:25', '2021-07-30 04:45:25'),
('EditEditPackage', 'Edit Package', 'Package', 'index', 'edit', '2021-09-08 11:56:39', '2021-09-08 11:56:39'),
('EditEditProductReview', 'Edit ProductReview', 'ProductReview', 'index', 'edit', '2021-06-22 10:37:00', '2021-06-22 10:37:00'),
('EditEditStore', 'Edit store', 'Zgstores', 'stores', 'edit', '2022-11-29 08:55:24', '2022-11-29 08:55:24'),
('EditEditStoreAgents', 'Edit store agents', 'stores', 'store_agents', 'edit', '2022-11-29 08:52:53', '2022-11-29 08:52:53'),
('EditEditTrending', 'Edit Trending', 'Trending', 'index', 'edit', '2021-09-08 11:52:49', '2021-09-08 11:52:49'),
('EditEditType', 'Edit Type', 'Type', 'index', 'edit', '2021-08-10 05:59:41', '2021-08-10 05:59:41'),
('editMENU', 'edit MENU', 'MENU', 'index', 'edit', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('EditOfferBanner', 'OfferBanner', 'OfferBanner', 'index', 'edit', '2021-07-05 02:14:15', '2021-07-05 02:14:15'),
('EditProducts', 'Products', 'Products', 'index', 'edit', '2021-06-14 11:37:49', '2021-06-14 11:37:49'),
('editSiteSettings', 'edit Site Settings', 'SiteSettings', 'index', 'edit', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('EditSuitableFor', 'SuitableFor', 'SuitableFor', 'index', 'edit', '2021-06-16 03:15:34', '2021-06-16 03:15:34'),
('ExportExportCategories', 'Export categories', 'supercontrol', 'category', 'export', '2022-06-22 15:38:53', '2022-06-22 15:38:53'),
('ExportExportList', 'Export brand list', 'supercontrol', 'brands', 'export', '2022-06-22 15:03:44', '2022-06-22 15:03:44'),
('FAQ', 'FAQ', 'Faq', 'index', NULL, '2021-07-20 04:54:48', '2021-07-20 04:54:48'),
('GiftWrapping', 'Gift Wrapping', 'GiftWrapping', 'index', NULL, '2021-06-21 03:48:59', '2021-06-21 03:48:59'),
('HomeSlider', 'home slider', 'banner', 'slider', NULL, '2021-10-09 04:19:14', '2021-10-09 04:19:14'),
('ImageList', 'Image list ', 'products', 'imagelist', NULL, '2022-08-05 16:07:56', '2022-08-05 16:07:56'),
('IndexAddAdmin', 'Add admin', 'Admin', 'index', 'add', '2021-06-13 10:24:10', '2021-06-13 10:24:10'),
('IndexAddSEO', 'Add SEO', 'SEO', 'index', 'add', '2021-06-14 02:45:33', '2021-06-14 02:45:33'),
('IndexAdmin', 'Admin', 'Admin', 'index', NULL, '2021-06-14 01:26:23', '2021-06-14 01:26:23'),
('IndexCategory', 'Category', 'Category', 'index', 'edit', '2021-06-14 11:34:07', '2021-06-14 11:34:07'),
('IndexDeleteAdmin', 'Delete Admin', 'Admin', 'index', 'delete', '2021-06-13 10:24:56', '2021-06-13 10:24:56'),
('IndexDeleteSEO', 'Delete SEO', 'SEO', 'index', 'delete', '2021-06-14 02:45:59', '2021-06-14 02:45:59'),
('IndexEditAdmin', 'Edit Admin', 'Admin', 'index', 'edit', '2021-06-13 10:24:31', '2021-06-13 10:24:31'),
('IndexEditSEO', 'Edit SEO', 'SEO', 'index', 'edit', '2021-06-14 02:45:47', '2021-06-14 02:45:47'),
('IndexProducts', 'Products', 'Products', 'index', 'add', '2021-06-14 11:34:45', '2021-06-14 11:34:45'),
('Listings', 'Listings', 'Listings', 'index', NULL, '2022-01-02 08:24:08', '2022-01-02 08:24:08'),
('Newsletter', 'Newsletter', 'Newsletter', ' ', NULL, '2021-09-14 12:09:47', '2021-09-14 12:09:47'),
('OfferBanner', 'OfferBanner', 'OfferBanner', 'index', NULL, '2021-07-05 02:13:58', '2021-07-05 02:13:58'),
('Orders', 'Orders', 'Orders', 'index', NULL, '2021-07-30 04:16:51', '2021-07-30 04:16:51'),
('Package', 'Package', 'Package', NULL, NULL, '2021-09-08 11:54:09', '2021-09-08 11:54:09'),
('ProductAttributes', 'Product attributes', 'variations', NULL, NULL, '2022-07-01 10:38:13', '2022-07-01 10:38:13'),
('ProductExport', 'product export', 'products', 'export', NULL, '2022-03-14 01:56:20', '2022-03-14 01:56:20'),
('ProductReview', 'ProductReview', 'ProductReview', 'index', NULL, '2021-06-22 10:36:37', '2021-06-22 10:36:37'),
('Products', 'Products', 'Products', NULL, NULL, '2021-06-14 11:35:13', '2021-06-14 11:35:13'),
('SEO', 'SEO', 'SEO', NULL, NULL, '2021-06-14 02:45:19', '2021-06-14 02:45:19'),
('Settings', 'Settings', 'Settings', 'index', 'edit', '2020-12-25 15:34:56', '2020-12-25 15:34:56'),
('StoreAgents', 'Store agents', 'stores', 'store_agents', NULL, '2022-11-29 08:56:07', '2022-11-29 08:56:07'),
('StoreCustomers', 'Store customers', 'stores', 'store_customers', NULL, '2022-11-29 08:53:15', '2022-11-29 08:53:15'),
('StoreReviews', 'Store reviews', 'stores', 'stores_reviews', NULL, '2022-11-29 08:53:32', '2022-11-29 08:53:32'),
('Stores', 'Stores', 'Zgstores', 'stores', NULL, '2022-11-29 08:55:47', '2022-11-29 08:55:47'),
('SuitableFor', 'SuitableFor', 'SuitableFor', NULL, NULL, '2021-06-16 03:15:56', '2021-06-16 03:15:56'),
('Tournaments', 'Tournaments', 'tournaments', 'registrations', NULL, '2022-12-07 11:39:23', '2022-12-07 11:39:23'),
('Trending', 'Trending', 'Trending', NULL, NULL, '2021-09-08 11:51:31', '2021-09-08 11:51:31'),
('Type', 'Type', 'Type', 'index', NULL, '2021-08-10 05:59:16', '2021-08-10 05:59:16'),
('Wheel', 'Wheel', 'wheel', NULL, NULL, '2022-11-07 15:30:02', '2022-11-07 15:30:02');
...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  `phone` varchar(222) COLLATE utf8_unicode_ci DEFAULT NULL,
  `password` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `image` varchar(222) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `admin_group` (
  ...
  `precedence` varchar(222) COLLATE utf8_unicode_ci DEFAULT NULL,
  `access_rights` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
--
-- Déchargement des données de la table `admin_group`
--

INSERT INTO `admin_group` (`group_id`, `name`, `description`, `precedence`, `access_rights`, `created_at`, `updated_at`) VALUES
('Admin', 'Admin', 'Admin', '2', 'Limited', '2021-06-13 10:36:32', '2022-03-14 05:42:33'),
('articles-editor-1684848291', 'Articles editor', NULL, '3', 'Blog', '2023-05-23 13:24:51', '2023-05-23 13:25:03'),
('banner-manager-1689840973', 'Banner manager', NULL, '3', NULL, '2023-07-20 08:16:13', '2023-07-20 08:16:13'),
('order-manager-1647236509', 'Order Manager', 'Order Manager', '4', 'Order ', '2022-03-14 05:41:49', '2022-03-14 05:42:57'),
('sales-supervisor-1647236535', 'Sales Supervisor', 'Sales Supervisor', '5', 'Sales ', '2022-03-14 05:42:15', '2022-03-14 05:43:00'),
('seo-blogs-1684935731', 'SEO & Blogs', 'Website SEO & blog management', '1', 'SEO', '2023-05-24 13:42:11', '2023-05-24 13:42:35'),
('stock-manager-1647236484', 'Stock Manager', 'Stock Manager', '3', 'Stock', '2022-03-14 05:41:24', '2022-03-14 05:42:52'),
('SuperAdmin', 'Super Admin', 'Super  Admin Full Access', '1', 'Full', '2020-12-25 09:25:54', '2022-03-14 05:42:30');
...
CREATE TABLE IF NOT EXISTS `age` (
  ...
  `arabic_title` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `arabic_description` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `color_code` varchar(222) DEFAULT NULL,
...
INSERT INTO `api_key` (`id`, `device`, `api_key`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Android', 'b6f26cacaee839b1c36591daa833a4c9', 'Active', '2021-06-22 01:53:41', '2021-06-22 01:53:41'),
(2, 'IOS', '40bb9d38c66e40a86678979286f4e2b5', 'Active', '2021-06-22 01:53:41', '2021-07-06 15:36:27');
...
CREATE TABLE IF NOT EXISTS `attributes` (
  ...
  `attribute_id` varchar(222) DEFAULT NULL,
  `title` varchar(222) DEFAULT NULL,
  `arabic_title` varchar(222) CHARACTER SET utf8mb4 DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `attribute_options` (
  ...
  `attribute_id` int(222) NOT NULL,
  `name` varchar(222) DEFAULT NULL,
  `thumb_url` varchar(333) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `banner` (
  ...
  `image` varchar(222) DEFAULT NULL,
  `mobile_image` varchar(222) DEFAULT NULL,
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `show_button` enum('Yes','No') NOT NULL DEFAULT 'No',
  `precedence` int(11) NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `blog` (
  `blog_id` int(222) NOT NULL AUTO_INCREMENT,
  `title` text DEFAULT NULL,
  `slug` varchar(333) DEFAULT NULL,
  `category` varchar(222) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `arabic_title` text CHARACTER SET utf8 DEFAULT NULL,
  `arabic_category` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `arabic_description` text CHARACTER SET utf8 DEFAULT NULL,
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `image` varchar(222) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`blog_id`)
...
CREATE TABLE IF NOT EXISTS `blog_categories` (
  ...
  `slug` varchar(222) NOT NULL,
  `arabic_name` varchar(222) CHARACTER SET utf8 NOT NULL,
  `cat_parent` int(33) NOT NULL,
...
--
-- Structure de la table `bundle_opt`
--

DROP TABLE IF EXISTS `bundle_opt`;
CREATE TABLE IF NOT EXISTS `bundle_opt` (
  `id` int(222) NOT NULL AUTO_INCREMENT,
  `option_group_id` int(222) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  `package` varchar(222) DEFAULT NULL,
  `bundle_opt` varchar(222) DEFAULT NULL,
  `discount_percentage` varchar(222) DEFAULT NULL,
  `discount_rounded` enum('Yes','No') DEFAULT NULL,
  `pre_order_enabled` enum('Yes','No') NOT NULL DEFAULT 'No',
  `pre_order_before_payment_percentage` int(11) DEFAULT NULL,
  `coupon_code` varchar(222) DEFAULT NULL,
  `assemble_professionally_price` int(222) DEFAULT NULL,
  `gift_wrapping` varchar(222) DEFAULT NULL,
  `gift_wrapping_note` text DEFAULT NULL,
  `quantity` int(11) NOT NULL DEFAULT 1,
  `coupon_type` varchar(222) DEFAULT NULL,
  `coupon_value` varchar(222) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9539 DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `category_banner`
--

DROP TABLE IF EXISTS `category_banner`;
CREATE TABLE IF NOT EXISTS `category_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` varchar(222) DEFAULT NULL,
  `title` varchar(222) DEFAULT NULL,
  `link` varchar(222) DEFAULT NULL,
  `location` enum('Menu','Page') NOT NULL DEFAULT 'Page',
  `description` varchar(222) DEFAULT NULL,
  `image` varchar(222) DEFAULT NULL,
  `mobile_image` varchar(222) DEFAULT NULL,
  `start_date` datetime DEFAULT NULL,
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `precedence` int(22) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `charges` (
  ...
  `applicable_maximum_amount` varchar(222) DEFAULT NULL,
  `applicable_minimum_amount` varchar(222) DEFAULT NULL,
  `title` varchar(222) NOT NULL,
  `arabic_title` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
...
INSERT INTO `city` (`city_id`, `title`, `arabic_title`, `status`, `created_at`, `updated_at`) VALUES
('abu-dhabi-1635404533', 'Abu Dhabi', 'أبو ظبي', 'Active', '2021-10-28 07:02:13', '2022-09-16 12:57:28'),
('ajman-1635404581', 'Ajman', 'عجمان', 'Active', '2021-10-28 07:03:01', '2022-09-16 12:57:35'),
('al-ain-1635404572', 'Al Ain', 'العين', 'Active', '2021-10-28 07:02:52', '2022-09-16 12:57:42'),
('all', 'All', 'All', 'Active', '2021-10-28 07:01:31', '2021-10-28 07:01:39'),
('dubai-1635404519', 'Dubai', 'دبي', 'Active', '2021-10-28 07:01:59', '2022-09-16 12:57:52'),
('fujairah-1669299829', 'Fujairah', 'الفجيرة', 'Active', '2022-11-24 14:23:49', '2022-11-24 14:23:49'),
('ras-al-khaimah-1669299782', 'Ras Al Khaimah', 'راس الخيمة', 'Active', '2022-11-24 14:23:02', '2022-11-24 14:23:02'),
('sharjah-1635404563', 'Sharjah', 'الشارقة', 'Active', '2021-10-28 07:02:43', '2022-09-16 12:58:01'),
('umm-al-quwain-1681216205', 'Umm Al Quwain', 'أم القوين', 'Active', '2023-04-11 12:30:05', '2023-04-11 12:30:05');
...
CREATE TABLE IF NOT EXISTS `cms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `heading` varchar(222) DEFAULT NULL,
  `arabic_heading` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `link` varchar(222) DEFAULT NULL,
  `image` varchar(222) DEFAULT NULL,
  `mobile_image` varchar(222) DEFAULT NULL,
  `description` blob DEFAULT NULL,
  `arabic_description` blob DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `color` (
  ...
  `image` varchar(222) DEFAULT NULL,
  `mobile_image` varchar(222) DEFAULT NULL,
  `show_in_home_page` enum('Yes','No') DEFAULT 'No',
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
...
--
-- Structure de la table `contact_us_form`
--
...
CREATE TABLE IF NOT EXISTS `coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `coupon_type` enum('specific','generic','one_time_coupon') DEFAULT 'generic',
  `coupon_code` varchar(222) NOT NULL,
  `title` text DEFAULT NULL,
  `coupon_uses` varchar(222) DEFAULT NULL,
  `coupon_sent` varchar(222) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `type` enum('Percentage','Amount') NOT NULL DEFAULT 'Percentage',
  `value` int(11) DEFAULT NULL,
  `min_cart_amount` int(11) DEFAULT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `on_brand` int(11) DEFAULT NULL,
  `on_category` varchar(111) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `coupon_code` (`coupon_code`)
) ENGINE=InnoDB AUTO_INCREMENT=1664880563 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Structure de la table `coupon_sent`
--

DROP TABLE IF EXISTS `coupon_sent`;
CREATE TABLE IF NOT EXISTS `coupon_sent` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customer` varchar(222) DEFAULT NULL,
...
--
-- Structure de la table `coupon_uses`
--
...
CREATE TABLE IF NOT EXISTS `faq` (
  ...
  `question_arabic` text CHARACTER SET utf8 DEFAULT NULL,
  `answer_arabic` text CHARACTER SET utf8mb4 DEFAULT NULL,
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
...
INSERT INTO `faq` (`id`, `question`, `answer`, `question_arabic`, `answer_arabic`, `status`, `created_at`, `updated_at`) VALUES
(1, 'How to place an order ?', 'Once you come across any item you would like to purchase, just click on “add to cart” and your item will be added to your shopping cart. All items you’ve selected will be saved in your gamezalley.ae shopping cart, which can be viewed at any time by clicking on the shopping cart link in the menu bar at the top of the page.', NULL, NULL, 'Active', '2021-07-31 02:40:48', '2021-08-23 12:29:49'),
(2, 'When i will receive my order ?\r\n', '<p>Our delivery timeframe is as follows:</p>\r\n\r\n<p>- Dubai &amp; Sharjah: 24h to 48h working days.</p>\r\n\r\n<p>- Other Emirates: 48h to 72h working days All orders will process and ship from Sunday to Thursday.</p>\r\n\r\n<p>- Orders placed on Friday &amp; Saturday will be processed and/or shipped the following business day.</p>\r\n\r\n<p>- We will not be processing or shipping orders on Weekends and Public Holidays according to UAE.</p>\r\n', NULL, NULL, 'Active', '2021-07-31 02:41:07', '2021-08-28 08:25:53'),
(3, 'Which regions do you ship to ?\r\n', 'Currently we are shipping to all UAE regions', NULL, NULL, 'Active', '2021-08-23 12:30:40', '2021-08-23 12:30:40'),
(4, 'Can i track the status of my order ?', '<p>If you have created an account you can find all your orders and their status under Profile-&gt;Orders. Also you can track them by clicking the &quot;Track&quot; button when it is enabled.</p>\r\n', NULL, NULL, 'Active', '2021-08-23 12:30:55', '2023-05-15 08:01:26'),
(5, 'How do i know that my order has been successfully received by zamzamgames ?', '<p>Just after you submitted your order, you will receive an email containing the order reference number and details of your purchase, or you can login to find all of your successful orders under your Account dashboard &gt; My Orders. Note: Please also check your Spam/Junk folder in your email box.</p>\r\n', NULL, NULL, 'Active', '2021-08-23 12:31:08', '2021-09-15 14:18:44'),
(6, 'Can i order without having an account ?', '<p>Yes you can always make orders without having account, but it&rsquo;s better for you to have one so that you can always have a clear overview on your purchases on zamzamgames.com</p>\r\n', NULL, NULL, 'Active', '2021-08-23 12:31:20', '2021-09-15 14:19:23'),
(7, 'Can i cancel my order ?', '<p>If you have an account on zamzamgames.com&nbsp;you can send a cancellation request by clicking on &ldquo;cancel&rdquo; button in the order row, that you want to cancel that can be found in &ldquo;my order&rdquo;s section. In case you don&rsquo;t have an account just send us an email on contact@zamzamgames.com&nbsp;with the number of the order specified in the subject.</p>\r\n', NULL, NULL, 'Active', '2021-08-23 12:31:32', '2021-09-15 14:26:22'),
(8, 'Can i go to your store and buy the games there myself ?', '<p>For now zamzamgames&nbsp;doesn&rsquo;t have a showroom yet but soon, So you have to make an online order on the zamzamgames web site to get your items.</p>\r\n', NULL, NULL, 'Active', '2021-08-23 12:31:45', '2021-09-16 12:31:26'),
(9, 'How do i contact zamzamgames.com ?', '<p>There are 3 ways to get in touch with zamzamgames customer service: - You can send us an email on contact@zamzamgames.com&nbsp;- Send a whatsup message by clicking on the button in the left bottom of the page or just use our number: +971 567 59 82 09 - You can always chat with us using the chat window in right bottom of the page, if we are not available for the chat you can also leave your message by entering your email address and your message and we will reply to you by email.</p>\r\n', NULL, NULL, 'Active', '2021-08-23 12:32:28', '2021-09-15 14:27:10'),
(10, 'What payment method do you accept ?', '<p>We accept cash on delivery, online payment with VISA, MASTER CARD and UNION PAY.</p>\r\n', NULL, NULL, 'Active', '2021-08-23 12:32:44', '2022-03-11 08:19:52'),
(11, 'Are the games brand-new ?', '<p>All the games proposed by zamzamgames are brand-new and original.</p>\r\n', NULL, NULL, 'Active', '2021-08-23 12:32:58', '2021-09-15 14:20:45'),
(12, 'Do you offer free shipping?', '<p>Yes We offer free shipping for orders above 100 aed purchase.</p>\r\n', NULL, NULL, 'Active', '2023-05-15 07:58:19', '2023-05-15 07:58:19');

-- --------------------------------------------------------

--
-- Structure de la table `gift_wrapping`
--
...
CREATE TABLE IF NOT EXISTS `gift_wrapping` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1627699395 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Structure de la table `google_product_categories`
--
...
--
-- Déchargement des données de la table `google_product_categories`
--

INSERT INTO `google_product_categories` (`id`, `category`) VALUES
...
--
-- Structure de la table `groups_assigned`
--

DROP TABLE IF EXISTS `groups_assigned`;
CREATE TABLE IF NOT EXISTS `groups_assigned` (
  `access_modules_id` varchar(222) COLLATE utf8_unicode_ci DEFAULT NULL,
  `group_id` varchar(222) COLLATE utf8_unicode_ci DEFAULT NULL,
  `precedence` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `home_slider` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` enum('left','right') NOT NULL DEFAULT 'left',
  `image` varchar(222) DEFAULT NULL,
  `link` varchar(222) DEFAULT NULL,
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
--
-- Structure de la table `master_category`
--

DROP TABLE IF EXISTS `master_category`;
CREATE TABLE IF NOT EXISTS `master_category` (
  `category_id` varchar(222) NOT NULL,
  `parent_id` varchar(222) DEFAULT '0',
  `precedence` int(11) NOT NULL DEFAULT 0,
  `category_name` varchar(222) DEFAULT NULL,
  `color_name` varchar(222) DEFAULT NULL,
  `category_description` varchar(222) DEFAULT NULL,
  `category_name_arabic` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `category_description_arabic` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `page_title` varchar(222) DEFAULT NULL,
  `page_keywords` varchar(222) DEFAULT NULL,
  `page_description` text DEFAULT NULL,
  `other_meta_tag` text DEFAULT NULL,
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `slug` varchar(222) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `show_category_page` enum('Yes','No') NOT NULL DEFAULT 'No',
...
--
-- Structure de la table `mobile_banner`
--

DROP TABLE IF EXISTS `mobile_banner`;
CREATE TABLE IF NOT EXISTS `mobile_banner` (
...
--
-- Structure de la table `newsletter_instance`
--

DROP TABLE IF EXISTS `newsletter_instance`;
CREATE TABLE IF NOT EXISTS `newsletter_instance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `subject` varchar(222) DEFAULT NULL,
  `promo_products` varchar(555) DEFAULT NULL,
  `schedule_date` datetime DEFAULT NULL,
  `status` enum('SENT','SCHEDULED','DRAFT','') NOT NULL DEFAULT 'DRAFT',
  `sent_to` int(222) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Structure de la table `newsletter_sections`
--
...
CREATE TABLE IF NOT EXISTS `newsletter_sections` (
  ...
  `section_title` varchar(222) DEFAULT NULL,
  `section_type` enum('BIG_SQUARE','MOSAIC','HORIZONTAL','SUNGLASSES') DEFAULT NULL,
  `section_order` int(11) DEFAULT NULL,
  `image_1` varchar(222) DEFAULT NULL,
  `image_2` varchar(222) DEFAULT NULL,
  `image_3` varchar(222) DEFAULT NULL,
  `image_4` varchar(222) DEFAULT NULL,
  `link_1` varchar(222) DEFAULT NULL,
  `link_2` varchar(222) DEFAULT NULL,
  `link_3` varchar(222) DEFAULT NULL,
  `link_4` varchar(222) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Structure de la table `offer_banner`
--
...
--
-- Structure de la table `opt_group`
--

DROP TABLE IF EXISTS `opt_group`;
CREATE TABLE IF NOT EXISTS `opt_group` (
  `id` int(222) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `city` varchar(222) DEFAULT NULL,
  `apartment_house` text CHARACTER SET utf8 DEFAULT NULL,
  `address` text CHARACTER SET utf8 DEFAULT NULL,
  `products` varchar(222) DEFAULT NULL,
  `coupon_code` varchar(222) DEFAULT NULL,
  `coupon_type` varchar(222) DEFAULT NULL,
  `coupon_value` varchar(222) DEFAULT NULL,
  `coupon_discount` varchar(222) DEFAULT NULL,
  `invoice` varchar(222) DEFAULT NULL,
  `sub_total` varchar(222) DEFAULT NULL,
  `charges` varchar(222) DEFAULT NULL,
  `total` varchar(222) DEFAULT NULL,
  `remarks` text DEFAULT NULL,
  `payment_method` enum('Online payment','Cash on devlivery') DEFAULT NULL,
  `refund_type` enum('Online','Offline','Wallet') DEFAULT NULL,
  `payment_status` enum('Paid','Not Paid','Refunded') NOT NULL DEFAULT 'Not Paid',
  `order_status` enum('Submited','Confirmed','Out for delivery','Delivered','Canceled','Pre-order') NOT NULL DEFAULT 'Submited',
  `wallet_use` enum('Yes','No') NOT NULL DEFAULT 'No',
  `wallet_used_amount` varchar(222) DEFAULT NULL,
  `tracking` varchar(222) DEFAULT NULL,
  `transaction_ref` varchar(222) DEFAULT NULL,
  `cancel_trans_ref` varchar(222) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
CREATE TABLE IF NOT EXISTS `order_products` (
  ...
  `sku` varchar(222) DEFAULT NULL,
  `package` varchar(222) DEFAULT NULL,
  `discount_percentage` varchar(222) DEFAULT NULL,
  `product_original_price` varchar(222) DEFAULT NULL,
  `gift_wrapping_price` text DEFAULT NULL,
  `gift_wrapping_image` text DEFAULT NULL,
  `assemble_professionally_price` int(222) DEFAULT NULL,
  `gift_wrapping` varchar(222) DEFAULT NULL,
  `gift_wrapping_note` text DEFAULT NULL,
  `user_id` varchar(222) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `package` (
  `package_id` varchar(222) NOT NULL,
  `title` varchar(222) NOT NULL,
  `products` varchar(222) DEFAULT NULL,
...
--
-- Structure de la table `package_products`
--
...
CREATE TABLE IF NOT EXISTS `package_products` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `package` varchar(222) DEFAULT NULL,
  `product` varchar(222) DEFAULT NULL,
  `discount_percentage` varchar(222) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
...
--
-- Structure de la table `payment_txn`
--
...
CREATE TABLE IF NOT EXISTS `payment_txn` (
  ...
  `transaction_ref` varchar(222) DEFAULT NULL,
  `transaction_type` varchar(222) DEFAULT NULL,
  `transaction_class` varchar(222) DEFAULT NULL,
  `transaction_message` varchar(222) DEFAULT NULL,
  `transaction_status` varchar(222) DEFAULT NULL,
  `transaction_code` varchar(222) DEFAULT NULL,
  `paymethod` varchar(222) DEFAULT NULL,
  `capture_amount` varchar(222) DEFAULT NULL,
  `capture_auth_message` varchar(222) DEFAULT NULL,
  `capture_auth_tranref` varchar(222) DEFAULT NULL,
  `email` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `name` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `line1` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `line2` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `city` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `state` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `country` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `areacode` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `mobile` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `products` (
  `product_id` varchar(222) NOT NULL,
  `category` varchar(222) DEFAULT NULL,
  `google_category` int(255) DEFAULT NULL,
  `type` varchar(222) DEFAULT NULL,
  `product_nature` enum('Variable','Simple','Variation') NOT NULL DEFAULT 'Simple',
  `parent` varchar(222) DEFAULT NULL,
  `attribute_variation` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`attribute_variation`)),
  `attributes` varchar(222) DEFAULT NULL,
  `name` varchar(222) DEFAULT NULL,
  `arabic_name` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `brand` varchar(222) DEFAULT NULL,
  `suitable_for` varchar(222) DEFAULT NULL,
  `age` varchar(222) DEFAULT NULL,
  `color` varchar(222) DEFAULT NULL,
  `price` decimal(10,0) DEFAULT NULL,
  `available_stock` varchar(11) NOT NULL DEFAULT '0',
  `max_qty_order` int(11) DEFAULT NULL,
  `order_interval` enum('Unlimited','Daily','Weekly','Monthly') DEFAULT 'Unlimited',
  `discount_percentage` varchar(222) DEFAULT NULL,
  `discount_rounded` enum('Yes','No') NOT NULL DEFAULT 'Yes',
  `offer_start_date` datetime DEFAULT NULL,
  `offer_end_date` datetime DEFAULT NULL,
  `description` text DEFAULT NULL,
  `arabic_description` text CHARACTER SET utf8 DEFAULT NULL,
  `features` text DEFAULT NULL,
  `arabic_features` text CHARACTER SET utf8 DEFAULT NULL,
  `gift_wrapping` enum('Yes','No') NOT NULL DEFAULT 'No',
  `assemble_professionally` enum('Yes','No') NOT NULL DEFAULT 'No',
  `assemble_professionally_price` decimal(10,0) DEFAULT NULL,
  `pre_order_enabled` enum('Yes','No') NOT NULL DEFAULT 'No',
  `pre_order_before_payment_percentage` int(11) DEFAULT NULL,
  `release_date` date DEFAULT NULL,
  `sku` varchar(255) DEFAULT NULL,
  `bundle_opt_enabled` enum('Yes','No') DEFAULT 'No',
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `valid_from` datetime DEFAULT NULL,
  `valid_until` datetime DEFAULT NULL,
  `set_as_new` enum('Yes','No') NOT NULL DEFAULT 'Yes',
  `new_from` datetime DEFAULT NULL,
  `new_until` datetime DEFAULT NULL,
  `page_title` varchar(222) DEFAULT NULL,
  `page_keywords` varchar(222) DEFAULT NULL,
  `page_description` varchar(222) DEFAULT NULL,
  `other_meta_tag` varchar(222) DEFAULT NULL,
  `images` varchar(222) DEFAULT NULL,
  `youtube_link` text DEFAULT NULL,
  `show_this_product_in_home_page` enum('Yes','No') NOT NULL DEFAULT 'No',
  `precedence` int(11) NOT NULL DEFAULT 1,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `slug` varchar(222) NOT NULL,
  `review_enabled` enum('Yes','No') NOT NULL DEFAULT 'Yes',
  `freebie` enum('Yes','No') NOT NULL DEFAULT 'No',
  `evergreen` enum('Yes','No') DEFAULT 'No',
...
CREATE TABLE IF NOT EXISTS `product_attributes` (
  `attribute_id` int(222) NOT NULL AUTO_INCREMENT,
  `name` varchar(222) DEFAULT NULL,
  `arabic_name` varchar(222) CHARACTER SET utf8 DEFAULT NULL,
  `attribute_order` int(22) DEFAULT NULL,
  `show_variation_image` enum('Yes','No') NOT NULL DEFAULT 'No',
...
--
-- Structure de la table `product_screenshot`
--

DROP TABLE IF EXISTS `product_screenshot`;
CREATE TABLE IF NOT EXISTS `product_screenshot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product` varchar(222) NOT NULL,
  `image` varchar(222) NOT NULL,
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38626 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `related_products` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` varchar(222) DEFAULT NULL,
  `related_product` varchar(222) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `seo` (
  `id` int(111) NOT NULL AUTO_INCREMENT,
  `segment_1` varchar(222) DEFAULT NULL,
  `segment_2` varchar(222) DEFAULT NULL,
  `segment_3` varchar(222) DEFAULT NULL,
  `page_title` varchar(222) DEFAULT NULL,
  `page_description` text DEFAULT NULL,
  `page_keywords` text CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `business_name` varchar(222) DEFAULT NULL,
  `business_description` varchar(222) DEFAULT NULL,
  `address` text DEFAULT NULL,
  `logo` varchar(222) DEFAULT NULL,
  `favicon` varchar(255) DEFAULT NULL,
  `email` varchar(255) NOT NULL,
  `email_2` varchar(222) DEFAULT NULL,
  `phone` text DEFAULT NULL,
  ...
  `tiktok` varchar(222) DEFAULT NULL,
  `android_app_link` varchar(255) DEFAULT NULL,
  `ios_app_link` varchar(255) DEFAULT NULL,
  `freebie_applicable_amount` varchar(222) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
...
INSERT INTO `settings` (`id`, `business_name`, `business_description`, `address`, `logo`, `favicon`, `email`, `email_2`, `phone`, `whatsapp_no`, `map`, `facebook`, `twitter`, `instagram`, `linkedin`, `youtube`, `tiktok`, `android_app_link`, `ios_app_link`, `freebie_applicable_amount`) VALUES
(1, 'ZGames', 'ZGames offers everything a gamer needs. Shop for video games, gaming accessories, gaming PCs, consoles and much more. ', 'Dubai, United Arab Emirates</br>\r\n\r\n', 'ZGames_550px_W.png', 'ZGames-logo-01-66570.png', 'contact@zamzamgames.com', 'info@zamzamgames.com', '+971 56 8016 786', '+971 56 8016 786', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1276.3757523995537!2d55.28008282428919!3d25.198642472371514!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xa5eda9fb3c93b69d!2sThe%20Dubai%20Mall!5e0!3m2!1sen!2sae!4v1646040095007!5m2!1sen!2sae\" width=\"100%\" height=\"308\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\"></iframe>', 'https://www.facebook.com/zamzam.games', 'https://twitter.com/zgames', 'https://www.instagram.com/zgamesme', 'https://www.linkedin.com/', 'https://www.youtube.com/zamzam.games', 'https://www.tiktok.com/@zgames', 'https://play.google.com/store', 'https://www.apple.com/in/app-store/', '200');
...
CREATE TABLE IF NOT EXISTS `stores` (
  ...
  `city` enum('Dubai','Sharjah','Jeddah','Al Riyadh','Doha','Tabuk','Dhahran') NOT NULL,
  `country` enum('United Arabe Emirates','Saudi Arabia','Qatar') NOT NULL,
  `phone` varchar(222) NOT NULL,
  `description` text DEFAULT NULL,
  `location` text DEFAULT NULL,
  `image_1` varchar(333) DEFAULT NULL,
  `image_2` varchar(333) DEFAULT NULL,
  `image_3` varchar(333) DEFAULT NULL,
  `image_4` varchar(333) DEFAULT NULL,
  `image_5` varchar(333) DEFAULT NULL,
  `image_6` varchar(333) DEFAULT NULL,
  `weekdays_start` time NOT NULL DEFAULT '10:00:00',
  `weekdays_end` time NOT NULL DEFAULT '23:00:00',
  `weekends_start` time NOT NULL DEFAULT '10:00:00',
  `weekends_end` time NOT NULL DEFAULT '00:00:00',
  `status` enum('Open','Opening soon') NOT NULL DEFAULT 'Open',
...
--
-- Structure de la table `store_customers`
--
...
--
-- Structure de la table `store_reviews`
--
...
CREATE TABLE IF NOT EXISTS `store_reviews` (
  ...
  `agent_id` int(222) NOT NULL,
  `store_id` int(222) NOT NULL,
  `rate` int(22) NOT NULL,
  `description` varchar(333) DEFAULT NULL,
  `receip_number` varchar(222) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `suitable_for`
--
...
--
-- Structure de la table `tournament_register`
--
...
--
-- Structure de la table `trending_products`
--
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user_type` enum('Guest','Normal') NOT NULL DEFAULT 'Normal',
  `name` varchar(222) DEFAULT NULL,
  `email` varchar(222) DEFAULT NULL,
  `password` varchar(222) DEFAULT NULL,
  `image` varchar(222) DEFAULT NULL,
  `country_code` varchar(222) DEFAULT NULL,
  `phone` varchar(222) DEFAULT NULL,
  `city` varchar(222) DEFAULT NULL,
  `address` varchar(222) DEFAULT NULL,
  `amount_spent` varchar(222) DEFAULT NULL,
  `total_orders` varchar(222) DEFAULT NULL,
  `status` enum('Active','Inactive') NOT NULL DEFAULT 'Inactive',
  `email_verification` enum('Verified','Not Verified') NOT NULL DEFAULT 'Not Verified',
  `social_inscription` varchar(222) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `verification_code` varchar(222) DEFAULT NULL,
  `token` varchar(222) DEFAULT NULL,
  `token_created_at` datetime DEFAULT NULL,
  `verify_method` enum('email','phone') NOT NULL DEFAULT 'email',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Structure de la table `user_spined_wheel`
--

DROP TABLE IF EXISTS `user_spined_wheel`;
CREATE TABLE IF NOT EXISTS `user_spined_wheel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(222) NOT NULL,
  `order_id` varchar(333) NOT NULL,
  `prize` varchar(333) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `wallet` (
  ...
  `user_id` varchar(222) DEFAULT NULL,
  `order_id` varchar(222) DEFAULT NULL,
  `type` enum('credited_from_card','credited_from_order_cancel') NOT NULL DEFAULT 'credited_from_order_cancel',
  `available_balance` varchar(222) DEFAULT NULL,
  `total` varchar(222) DEFAULT NULL,
  `status` enum('Used','Active','Inactive','Refunded') NOT NULL DEFAULT 'Active',
  `ref` varchar(222) DEFAULT NULL,
  `transaction_ref` varchar(222) DEFAULT NULL,
  `last4` varchar(222) DEFAULT NULL,
  `charge` varchar(222) DEFAULT NULL,
  `object` varchar(222) DEFAULT NULL,
  `brand` varchar(222) DEFAULT NULL,
  `cancel_trans_ref` varchar(222) DEFAULT NULL,
  `funding` varchar(222) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`)
...
--
-- Contraintes pour la table `bundle_opt`
--
ALTER TABLE `bundle_opt`
  ADD CONSTRAINT `Delete ` FOREIGN KEY (`option_group_id`) REFERENCES `opt_group` (`id`) ON DELETE CASCADE;
COMMIT;
